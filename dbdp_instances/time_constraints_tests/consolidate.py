...
_path="C:/Users/bferrari/Desktop/pessoal/"
...
df_vns = pd.concat([pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_vns.xlsx", sheet_name="results"),
                        pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_vns_1.xlsx", sheet_name="results"),
...
df_ts = pd.concat([pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_tabu.xlsx", sheet_name="results"),
                        pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_tabu_1.xlsx", sheet_name="results"),
...
df_gs =  pd.concat([pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_grasp.xlsx", sheet_name="results"),
...
df_gs_vns =  pd.concat([pd.read_excel(_path+"bdp/dbdp_instances/time_constraints_tests/meta_grasp_vns.xlsx", sheet_name="results"),
...
with pd.ExcelWriter(_path+"bdp/dbdp_instances/time_constraints_tests/final_results.xlsx") as writer:
